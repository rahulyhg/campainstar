...
<ol class="breadcrumb">
				...
				<div id="page-content">
					...
					<div class="panel">
						...
						<!--===================================================-->
						<div class="panel-body">
							<table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle fpTable lcnp" data-page-size="7">
								<thead>
									<tr>
										<th data-sort-ignore="true" class="min-width"></th>
										<th data-sort-initial="true" data-toggle="true">Name</th>
										<th data-hide="phone, tablet">Start Date</th>
										<th data-hide="phone, tablet">Test Date</th>
										<th data-hide="phone, tablet">Publishing Date</th>
										<th data-hide="phone, tablet">Groups</th>
...
-->
								<tbody>
									...
									<tr>
										<td>
										<a href="<?php echo site_url('site/deletecampaignbyuser?id=').$row->id; ?>" class="demo-delete-row btn btn-danger btn-s btn-icon fa fa-times" onclick="return confirm('Are you sure you want to delete?')">
...
<!--										<button class="demo-delete-row btn btn-danger btn-xs btn-icon fa fa-times"></button>-->
							...
							<a href="<?php echo site_url('site/viewcampaigngroup?id=').$row->id; ?>" class="btn btn-danger btn-s">
								<i class="icon-eye-open "></i>
							</a>
<!--										<button class=" btn btn-primary btn-xs btn-icon fa fa-times">Edit</button><button class="demo-delete-row btn btn-danger btn-xs btn-icon fa fa-times">View</button>-->
										</td>
<!--										<td><span class="label label-table label-success">Active</span></td>-->
