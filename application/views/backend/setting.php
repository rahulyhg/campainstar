...
-->
									...
									<!--Form-->
									<form class="form-horizontal bg" action="<?php echo site_url('account/billing');?>">
                                        <div class="formspac divplus">
                                        
													<div>Which Email system You use?</div>
													<div><input type="text" class="form-control txt" name="" placeholder="Does your company have brand guidelines?"></div><br>
<div>Does your company have brand guidelines?</div>

<div><input type="radio" class="guildlineradio"> &nbsp;Yes &nbsp;&nbsp;&nbsp; <input type="radio" class="guildlineradio"> &nbsp;NO</div><br>
                             
                                                   <div>If yes, Kindly upload brand guidlines</div>
													<div><input type="text" class="form-control txt" name="If yes, Kindly upload brand guidlines" placeholder="Username"></div>
