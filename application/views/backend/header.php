...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/footable.core.css'); ?>" type="text/css" />
        ...
        <div class="navbar-content clearfix">
          <ul class="nav navbar-top-links pull-left">
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-md with-arrow">
                <div class="pad-all bord-btm">
                  <p class="text-lg text-muted text-thin mar-no">You have 0 messages.</p>
                </div>
                <div class="nano scrollable hidden">
                  <div class="nano-content">
                    <ul class="head-list">
          ...
          <ul class="nav navbar-top-links pull-right">
            ...
            <li id="dropdown-user" class="dropdown">
              <?php $name=$this->session->userdata("name");if($name && $name!="") {?>
