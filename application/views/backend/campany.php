...
-->
									...
									<!--Form-->
									<form class="form-horizontal bg" action="<?php echo site_url('account/settingredirect');?>" method="post">
                                        <div class="formspac">
                                         <div class="form-group">
														<label class="col-lg-3 control-label txt">Campany Name</label>
														<div class="col-lg-7">
															<input type="text" class="form-control txt" name="campanyname" placeholder="Company Name">
														</div>
													</div>                                        
													 <div class="form-group">
														<label class="col-lg-3 control-label">Campany Url</label>
														<div class="col-lg-7">
															<input type="text" class="form-control txt" name="campanyurl" placeholder="Company URl">
														</div>
													</div>
                              													 <div class="form-group">
														<label class="col-lg-3 control-label">Upload Logo</label>
														<div class="col-lg-7">
															<input type="text" class="form-control txt" name="uploadlogo" placeholder="Upload Logo">
														</div>
													</div>
                              													 <div class="form-group">
														<label class="col-lg-3 control-label">Select Industry</label>
														<div class="col-lg-7">
															<input type="text" class="form-control txt" name="selectindustry" placeholder="Select Industry">
														</div>
													</div>
										...
										<div  class="button">
                                             ...
                                             <a href="<?php echo site_url('account/details'); ?>" class="back">Back</a>
